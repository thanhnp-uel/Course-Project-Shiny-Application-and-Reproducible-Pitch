...
The application is running on https://ngophuthanh.shinyapps.io/ngophuthanh/)

ui.R, and Server.R Code in my github repository
(https://github.com/thanhnp-uel/Course-Project-Shiny-Application-and-Reproducible-Pitch)
